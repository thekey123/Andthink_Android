...
import com.andthink.mvc.IRefreshView.OnRefreshListener;
import com.andthink.mvc.imp.DefaultLoadViewFactory;
import com.andthink.mvc.viewhandler.ListViewHandler;
import com.andthink.mvc.viewhandler.ViewHandler;
import com.andthink.utils.NetworkUtils;
...
public class MVCHelper<DATA> {
    //此data是dataresouce里边的data，只记录位置
    private DATA data;
    ...
    public void setAdapter(IDataAdapter<DATA> adapter) {
        ...
        //从dataresouce里传过来，避免在adapter在添加
